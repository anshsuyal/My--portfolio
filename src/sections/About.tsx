...
export function About() {
  return (
    <section id="about" className="relative overflow-hidden px-4 py-24 md:py-32 md:px-8 bg-transparent">
            ...
            <div className="mt-12 grid grid-cols-2 gap-6 md:grid-cols-4">
              {stats.map((stat, i) => (
                ...
                >
                  ...
                  <p className="mt-1 text-[10px] font-bold uppercase tracking-widest text-white/40">{stat.label}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {services.map((svc, i) => (
              <motion.div
                ...
                className="group relative rounded-2xl border border-white/10 bg-white/5 p-6 shadow-[0_1px_2px_rgba(0,0,0,0.02),0_4px_12px_rgba(0,0,0,0.04)] transition-all hover:shadow-[0_4px_16px_rgba(0,0,0,0.08)] hover:border-[#6366f1]/40 hover:scale-[1.02]"
              >
                ...
                <p className="mt-2 text-sm text-white/50 leading-relaxed">{svc.desc}</p>
